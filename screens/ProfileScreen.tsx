      ...
      <View className="flex flex-col w-full">
        <View className="relative h-[300px]">
          ...
          <SafeAreaView className="flex flex-row items-center justify-between w-full h-full px-8">
            ...
            <View>
              {profile?.image ? (
                <View className="w-24 h-24 rounded-full border-[1px] border-white flex items-center justify-center relative bg-[rgba(229,231,235,1)]">
                  <TouchableOpacity
                    onPress={pickImage}
                    className="absolute right-0 bottom-2 w-8 h-8 bg-white flex items-center justify-center z-[1] rounded-full opacity-90"
                  >
                    <Text className="text-xl">+</Text>
                  </TouchableOpacity>
                  <View className="w-[100px] h-[100px] rounded-full overflow-hidden bg-gray-200/20 flex items-center justify-center">
